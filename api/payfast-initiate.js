...
export default async function handler(req, res) {
  try {
    ...
    const {
      ...
      billing = "monthly",       // "monthly" | "annual" (we’ll feed PayFast monthly for now)
      amount = 0,
      signupId = "",
      name = "",
      email = "",
    ...
    // Subscription flags (we keep monthly frequency for both paths until PayFast enables true annual)
    ...
    // Remove undefined fields (PayFast doesn’t like “undefined” form fields)
