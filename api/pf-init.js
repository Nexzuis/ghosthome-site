// /api/pf-init.js
// Builds PayFast subscription fields and signature (docs: alpha sort, PHP urlencode with '+', append &passphrase, MD5).
...
module.exports = (req, res) => {
  try {
    ...
    const engine = MODE === "live" ? "https://www.payfast.co.za/eng/process"
