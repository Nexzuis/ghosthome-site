...
const PACKAGES = [
  {
    ...
    details: {
      ...
      includes: [
        "1× Video Doorbell",
        "2× Smart Buttons (assignable)",
        "Indoor chime-capable hub",
      ],
      features: [
        "AI person detection",
        "Snapshot to phone",
        "Night vision",
        "Alarm/armed response link capable",
      ],
    },
  },
  {
    ...
    details: {
      ...
      includes: [
        "2× Wi-Fi battery cams",
        "Solar trickle or chargers",
        "Chime hub",
      ],
      features: [
        "AI person/pet/vehicle detection",
        "Line-crossing rules",
        "Automations (lights/plugs)",
        "Optional alarm I/O link",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    details: {
      ...
      includes: [
        "1× Doorbell",
        "2× Pan/Tilt outdoor cams",
        "Chime hub",
      ],
      features: [
        "Motion tracking (PT)",
        "Line-crossing & zones",
        "Automations (lights/sirens)",
        "Alarm panel link capable",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    details: {
      ...
      features: [
        "AI + line-crossing",
        "Lighting siren automations",
        "Schedules & arming",
        "Alarm/armed response link",
      ],
    },
  },
  {
...
export default function Packages() {
  ...
  const toggleCompare = (id) =>
    setCompareSel((prev) => {
      ...
      if (prev.length >= 2) {
        // replace the first with the new to keep max 2
        return [prev[1], id];
      }
      return [...prev, id];
    });
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-bold text-slate-900">Packages &amp; Solutions</h1>
      ...
      <section className="mt-6">
        ...
        <p className="mt-2 text-xs text-slate-500">
          Tip: Choose a couple of tags (e.g. <span className="font-medium">Wired</span> + <span className="font-medium">4 Cam</span>) to narrow the grid.
        </p>
      </section>
        ...
        <div className="flex flex-col items-start justify-between gap-3 rounded-xl border border-slate-200 bg-white p-3 sm:flex-row sm:items-center">
          <div className="flex items-center gap-2 text-sm text-slate-700">
            ...
            <span className="text-slate-600">
              select up to two cards → click Compare
            </span>
          </div>
          ...
          >
            ...
            <div className="mb-2 flex items-start justify-between gap-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="rounded-lg border border-slate-200 p-2 text-slate-600 hover:bg-slate-50 hover:text-slate-800"
                >
                  {copiedId === pkg.id ? (
            ...
            <div className="mt-4 flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  href={`https://wa.me/27794950855?text=${encodeURIComponent(
                    `Hi Ghosthome 👋 I'm interested in: ${pkg.title}`
                  )}`}
                  target="_blank"
                  rel="noreferrer"
    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.aside
          ...
          role="dialog"
          aria-modal="true"
          className="absolute right-0 top-0 h-full w-full max-w-xl overflow-y-auto border-l border-slate-200 bg-white shadow-xl"
        >
          ...
          <div className="px-4 py-4">
            ...
            <div className="mt-5 flex flex-wrap items-center gap-2">
              <a
                href={`https://wa.me/27794950855?text=${encodeURIComponent(
                  `Hi Ghosthome 👋 I'm looking at: ${pkg.title}`
                )}`}
                target="_blank"
                rel="noreferrer"
            ...
            <p className="mt-4 text-xs text-slate-500">
              Power & connectivity: Wi-Fi must cover camera positions (or choose 4G models). UPS for wired units can be quoted at very low cost (recommended). Link to your normal alarm & armed response available.
            </p>
          </div>
        </motion.aside>
      </motion.div>
